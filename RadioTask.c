...
const PIN_Config RADIO_TASK_GPIO_CONFIG[] = {

CC1190_PA_EN | PIN_GPIO_OUTPUT_EN | PIN_GPIO_LOW | PIN_PUSHPULL | PIN_DRVSTR_MAX,

CC1190_LNA_EN | PIN_GPIO_OUTPUT_EN | PIN_GPIO_LOW | PIN_PUSHPULL
| PIN_DRVSTR_MAX,

CC1190_HGM | PIN_GPIO_OUTPUT_EN | PIN_GPIO_LOW | PIN_PUSHPULL
| PIN_DRVSTR_MIN,
...
static PIN_Handle radioTaskPinHandle;
static PIN_State radioTaskPinState;
...
static void radioTaskFunction(UArg arg0, UArg arg1)
{
    ...
    //CC1190 Setup
    radioTaskPinHandle = PIN_open(&radioTaskPinState, RADIO_TASK_GPIO_CONFIG);

    if (radioTaskPinHandle == NULL)
    {
    ...
    //PA LNA Enable Or Bypass Setup
    PIN_setOutputValue(radioTaskPinHandle, CC1190_HGM, 1);
    //LNA Pin
    PINCC26XX_setMux(radioTaskPinHandle, CC1190_LNA_EN, PINCC26XX_MUX_RFC_GPO0);
    //PA Pin
    PINCC26XX_setMux(radioTaskPinHandle, CC1190_PA_EN, PINCC26XX_MUX_RFC_GPO1);
